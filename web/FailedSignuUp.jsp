                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                <tr>
                                    <td align="center" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
                                        <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;"> You assigned Unvalid data</h1>
                                        <h3>  Please make sure that:   </h3>
                                        <p>  first name & last name must be only letters,
                                             Email must be with right format #####@####,
                                             username length must be more than 3 and only letters,
                                             password length must be more than 5,
                                             Confirm password must be identical to password</p>
                                    </td>
                                </tr>
                            </table>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                                                <a href="Signup.jsp" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; background-color: #48ca5f; text-decoration: none; border-radius: 6px;">Signup</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
